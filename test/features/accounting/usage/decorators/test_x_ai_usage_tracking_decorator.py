...
class XAIUsageTrackingDecoratorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.image_size = "1k"
        external_tool = stubs.domain.external_tool(id = "grok-imagine-image")
        configured_tool = stubs.domain.configured_tool(definition = external_tool, purpose = ToolType.images_gen, uses_credits = False)
    ...
    def test_sample_tracks_usage_by_image_size(self):
        ...
        self.assertEqual(call_args.kwargs["tool"].id, "grok-imagine-image")
    ...
    def test_chat_sample_tracks_provider_reported_cost(self):
        ...
        self.assertEqual(call_kwargs["tool"].id, "grok-imagine-image")
        ...
        self.mock_spending_service.deduct.assert_called_once_with(self.mock_spending_service.validate_pre_flight.call_args.args[0], 3.5)  # ruff: ignore[line-too-long]
    ...
    def test_sample_deducts_credits(self):
        ...
        self.mock_spending_service.deduct.assert_called_once_with(self.mock_spending_service.validate_pre_flight.call_args.args[0], 2.0)  # ruff: ignore[line-too-long]
    ...
    def test_sample_calls_validate_pre_flight(self):
        ...
        configured_tool = self.mock_spending_service.validate_pre_flight.call_args.args[0]
    ...
    def test_no_output_image_sizes(self):
        configured_tool = stubs.domain.configured_tool(
            definition = stubs.domain.external_tool(id = "grok-imagine-image"),
