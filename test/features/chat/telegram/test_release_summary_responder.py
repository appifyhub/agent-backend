...
class ReleaseSummaryResponderTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.release_output_b64 = base64.b64encode(json.dumps(release_output_json).encode()).decode()
    ...
    def test_is_chat_subscribed_major(self):
        chat = stubs.domain.chat_config(release_notifications = ChatConfigDB.ReleaseNotifications.major)
    ...
    def test_version_match(self, mock_config):
        ...
        payload = stubs.api.release_output_payload(release_output_b64 = self.release_output_b64)
        result = respond_with_summary(payload, self.mock_di)
