...
from features.announcements.release_summary_responder import respond_with_summary
...
if __name__ == "__main__":
    if "--dev" in sys.argv:  # when running locally...
        ...
        subprocess.run(["./tools/db_apply_migration", "-y"], check = True, env = migration_env)
